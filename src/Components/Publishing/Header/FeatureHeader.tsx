...
class FeatureHeaderComponent extends React.Component<FeatureHeaderProps, any> {
  ...
  renderFeatureAsset = (url, layout, isMobile, title, imageChild) => {
    const { url, type, isMobile, article.title, image }
  ...
  renderMobileSplitAsset(url, layout, isMobile, title, imageChild) {
  ...
  renderTextLayoutAsset(url, layout, title, imageChild) {
    if (layout === "text") {
      if (isVideo(url)) {
        return (
          <TextAsset>
        ...
        <Responsive initialState={{ isMobile: passedIsMobile }}>
          {({ isMobile }) => (
            <FeatureHeaderContainer
              ...
              height={height}
            >
              {this.renderFeatureAsset(url, layout, isMobile, title, imageChild)}
